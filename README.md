# nvim-treesitter-queries-soql

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-soql/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-soql/actions/workflows/validate.yml)

Neovim tree-sitter queries for **soql**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-soql",
...
- [ ] Changes are scoped to `soql` — do not include files for other languages
